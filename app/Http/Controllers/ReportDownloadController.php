...
class ReportDownloadController extends Controller
{
    public function __invoke(Request $request, string $type)
    {
        ...
        $data = match ($type) {
            ...
            'stock-movements' => $this->stockMovementData($startDate, $endDate),
            'activity-logs' => $this->activityLogData($startDate, $endDate),
        };
    ...
    private function stockMovementData(Carbon $startDate, Carbon $endDate): array
    {
        return [
    ...
    private function activityLogData(Carbon $startDate, Carbon $endDate): array
    {
        return [
